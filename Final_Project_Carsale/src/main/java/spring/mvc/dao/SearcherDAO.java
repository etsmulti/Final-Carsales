...
import spring.mvc.model.SearcherBean;
...
public class SearcherDAO {
	...
	public boolean insertMember(SearcherBean mb) throws SQLException{
		String sql=null;
	...
	public SearcherBean getMember(String id) throws SQLException{
		SearcherBean member=null;
		String sql=null;
	...
	public void updateMember(SearcherBean mb) throws SQLException{
		String sql=null;
	...
	public SearcherBean findId(String name, String jumin1, String jumin2)
	throws SQLException{
		String sql=null;
		SearcherBean member=null;
